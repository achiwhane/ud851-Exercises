...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    // DONE (5) Implement OnClickListener in the ForecastAdapterViewHolder class
    /**
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        // DONE (6) Override onClick, passing the clicked item's position (getAdapterPosition()) to mClickHandler via its onListItemClick method
        ...
        public void onClick(View view) {
            ...
            // invoke the onClickListener of the Adapter
