...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder>{
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        boolean attatchToParent = false;
        View view = LayoutInflater.from(context).inflate(R.layout.number_list_item, parent, attatchToParent);
        NumberViewHolder vh = new NumberViewHolder(view);
